...
<html>
    ...
    <body id="_1">
        ...
        <ul id="nav-bar">
            ...
            <a href="contacts.php"><li>Contact Us</li></a>
            <?php
                }
                else{
            ?>
        ...
        <div id="content">
            <div id="searchbox">
                <center>
                    <div class="heading">
                        <h1 class="logo"><div id="ntro">Edugram</div><!--<div id="E">E</div><div id="cir">E</div><div id="ntro">Edugram</div>--></h1>
